...
namespace ePassport.API
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "ePassport.API");
        ...
        {
            return String.Format("{0}{1}", ConfigurationManager.AppSettings["api:xml:path"], "ePassport.API.xml");
        }

        private static string GetXmlCommentsModelPath()
        {
            return String.Format("{0}{1}", ConfigurationManager.AppSettings["api:xml:path"], "ePassport.MODEL.xml");
        }
